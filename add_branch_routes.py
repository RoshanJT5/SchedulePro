# Script to add branch routes to app_with_navigation.py

with open('app_with_navigation.py', 'r', encoding='utf-8') as f:
    content = f.read()

# Find insertion point - right before "# Faculty Management"
insert_marker = "# Faculty Management"
insert_pos = content.find(insert_marker)

if insert_pos == -1:
    print("ERROR: Could not find Faculty Management marker")
    exit(1)
...
# Insert branch routes before Faculty Management
new_content = content[:insert_pos] + branch_routes + content[insert_pos:]

# Write back
with open('app_with_navigation.py', 'w', encoding='utf-8') as f:
    f.write(new_content)

print("SUCCESS: Branch routes added to app_with_navigation.py")
